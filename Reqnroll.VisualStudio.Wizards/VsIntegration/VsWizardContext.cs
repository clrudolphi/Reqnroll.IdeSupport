...
using Reqnroll.IDE.Common.ProjectSystem.Settings;
...
using OriginalIdeScope = Reqnroll.IDE.Common.IIdeScope;
using OriginalProjectScope = Reqnroll.IDE.Common.ProjectSystem.IProjectScope;
using OriginalProjectSettings = Reqnroll.IDE.Common.ProjectSystem.Settings.ProjectSettings;
