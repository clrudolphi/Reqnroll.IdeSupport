...
#pragma warning restore VSTHRD100
    ...
    public void ThenThereIsAStepWithRegex(Reqnroll.IdeSupport.LSP.Core.Parsing.Gherkin.ScenarioBlock stepType, string stepDefRegex)
    {
    ...
    public void ThenThereIsAStepWithSourceFileContaining(Reqnroll.IdeSupport.LSP.Core.Parsing.Gherkin.ScenarioBlock stepType, string expectedPathPart)
    {
        _bindingRegistry.Should().NotBeNull();
        _bindingRegistry.StepDefinitions.Should().Contain(sd =>
