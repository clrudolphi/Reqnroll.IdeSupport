...
Re-homed from the Visual Studio specs.  These run the real ported out-of-process connector
against a prebuilt Reqnroll bindings fixture (latest Reqnroll, net10) and assert on the resulting
