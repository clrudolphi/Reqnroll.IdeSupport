...
| `action` (×3) | `FindUnusedStepDefinitionsAction`, `FindStepUsagesAction`, `ReqnrollToggleCommentAction` | F15 (Tools menu) / F14 (Tools menu + editor context menu) / F13 (Tools menu + editor context menu + `Ctrl+/` keystroke) |
